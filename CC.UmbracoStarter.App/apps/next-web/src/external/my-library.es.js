 ...
 */
const M = globalThis, I = M.ShadowRoot && (M.ShadyCSS === void 0 || M.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, B = Symbol(), J = /* @__PURE__ */ new WeakMap();
let it = class {
  constructor(t, e, s) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: pt, defineProperty: ut, getOwnPropertyDescriptor: $t, getOwnPropertyNames: ft, getOwnPropertySymbols: _t, getPrototypeOf: mt } = Object, _ = globalThis, Z = _.trustedTypes, gt = Z ? Z.emptyScript : "", z = _.reactiveElementPolyfillSupport, S = (r, t) => r, N = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? gt : null;
      break;
  ...
  return e;
} }, V = (r, t) => !pt(r, t), F = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: V };
...
y.elementStyles = [], y.shadowRootOptions = { mode: "open" }, y[S("elementProperties")] = /* @__PURE__ */ new Map(), y[S("finalized")] = /* @__PURE__ */ new Map(), z == null || z({ ReactiveElement: y }), (_.reactiveElementVersions ?? (_.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w = globalThis, R = w.trustedTypes, G = R ? R.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, rt = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, ot = "?" + f, At = `<${ot}>`, A = document, C = () => A.createComment(""), x = (r) => r === null || typeof r != "object" && typeof r != "function", W = Array.isArray, yt = (r) => W(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Q = /-->/g, X = />/g, m = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Y = /'/g, tt = /"/g, nt = /^(?:script|style|textarea|title)$/i, vt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), bt = vt(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), et = /* @__PURE__ */ new WeakMap(), g = A.createTreeWalker(A, 129);
function ht(r, t) {
...
const Et = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === E ? p[1] === "!--" ? o = Q : p[1] !== void 0 ? o = X : p[2] !== void 0 ? (nt.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = m) : p[3] !== void 0 && (o = m) : o === m ? p[0] === ">" ? (o = i ?? E, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? m : p[3] === '"' ? tt : Y) : o === tt || o === Y ? o = m : o === Q || o === X ? o = E : (o = m, i = void 0);
    const $ = o === m && r[a + 1].startsWith("/>") ? " " : "";
    n += o === E ? h + At : l >= 0 ? (s.push(c), h.slice(0, l) + rt + h.slice(l) + f + $) : h + f + (l === -2 ? a : $);
  }
    ...
    for (; (i = g.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(rt)) {
          ...
          h.push({ type: 1, index: n, name: T[2], strings: $, ctor: T[1] === "." ? wt : T[1] === "?" ? Pt : T[1] === "@" ? Ct : k }), i.removeAttribute(l);
...
class H {
  ...
  k(t) {
    ...
    const e = this._$AH;
    let s, i = 0;
    for (const n of t) i === e.length ? e.push(s = new H(this.O(C()), this.O(C()), this, this.options)) : s = e[i], s._$AI(n), i++;
...
class k {
  ...
  _$AI(t, e = this, s, i) {
    ...
    if (n === void 0) t = b(this, t, e, 0), o = !x(t) || t !== this._$AH && t !== v, o && (this._$AH = t);
      ...
      const a = t;
      let h, c;
      for (t = n[0], h = 0; h < n.length - 1; h++) c = b(this, a[s + h], e, h), c === v && (c = this._$AH[h]), o || (o = !x(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + n[h + 1]), this._$AH[h] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
D == null || D(U, H), (w.litHtmlVersions ?? (w.litHtmlVersions = [])).push("3.2.1");
const Ut = (r, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ht = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: V }, Tt = (r = Ht, t, e) => {
...
var Mt = Object.defineProperty, Nt = Object.getOwnPropertyDescriptor, q = (r, t, e, s) => {
...
//# sourceMappingURL=my-library.es.js.map
